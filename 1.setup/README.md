...
> Markdown - это простой язык разметки, который позволяет быстро и легко структурировать текст с помощью символов и
> позволяет конвертировать его в HTML. Он широко используется в компаниях, таких как GitHub, Slack, Reddit, для написания
> README файлов, сообщений, комментариев, документации и других текстов с целью быстрой и удобной разметки контента.
...
> При просмотре `.md` файлов не забывайте переключить в режим изображения
![](.README_images/loking_readme.png)
...
![](.README_images/init_project_ready.png)
